...
<body>
  ...
  if (isset($_POST['submit'])) {
    ...
    $insertQuery = "INSERT INTO emp_tbl values ($empID, '$empName', $empAge, '$empEmail', '$empDesig', $empSalary, '$empCity')";
    ...
    if ($result == true) {
      echo "<script>alert('Employee Data Successfully Inserted Into DataBase')</script>";
    }
  }
