...
<div class="container text-center mt-3">
    <h1>FORM USING GET METHOD IN PHP</h1>
</div>

<div class="container mt-4" id="form_body">
    <form action="form1_get_method.php" onsubmit="return formValidation()" method="GET">
...
$empFirst_Name = $_GET['fname'];
$empLast_Name = $_GET['lname'];
$empEmail = $_GET['email'];
$empAge = $_GET['age'];
$empContact = $_GET['contact'];
$empPass = $_GET['password'];
$empCpass = $_GET['cpassword'];
$empGender = $_GET['gender'];
